    ...
    build: {
        ...
        rollupOptions: {
            output: [
                ...
                { entryFileNames: retainMinSuffix(pkg.main, false), format: 'cjs', exports: 'default', },
                { entryFileNames: retainMinSuffix(pkg.main, true), format: 'cjs', exports: 'default', },
                { entryFileNames: retainMinSuffix(pkg.unpkg, false), format: 'umd', name: 'mitt', },
                { entryFileNames: retainMinSuffix(pkg.unpkg, true), format: 'umd', name: 'mitt', },
            ],
        },
    }
});